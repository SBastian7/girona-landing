...
function WhatIs() {
    return (
        <section id="what-is-section" className="main-content bg-what-is text-shadow-sm flex flex-col items-center justify-center " style={{ minHeight: '100vh' }} >
            <div className="text-3xl md:text-4xl xl:text-5xl gothamFont uppercase font-extrabold">
                ¿Qué es?
            </div>
            <p className="text-base md:text-xl xl:text-2xl mt-16 text-center w-5/6 md:w-3/6">
            ...
            <p className="text-base md:text-xl xl:text-2xl gothamFont mt-9 text-center w-5/6 md:w-3/6">
            ...
            <NextSectionChevron target="#what-includes-section-0" />
        </section>
    );
}
