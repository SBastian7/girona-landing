function WhatIs() {
    return (
        <section id="what-is-section" className="main-content bg-what-is flex flex-col items-center justify-center min-h-screen" >
            <div className="text-shadow text-5xl montiliviFont">
                ¿Qué es?
            </div>
            <p className="text-2xl mt-16 text-center text-shadow w-3/6">
            ...
            <p className="text-2xl gothamFont mt-9 text-center text-shadow w-3/6">
