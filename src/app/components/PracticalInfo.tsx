...
function PracticalInfo() {
    ...
    const sectionContent = (
        <div className="grid grid-cols-12 text-base md:text-xl text-start" style={{ lineHeight: '25px' }} >
            ...
            <div className="col-span-6 ps-7 pt-5 my-4">
                1 hora
            </div>
            <div className="col-span-2"></div>
            ...
            <div className="col-span-6 ps-7 pt-5 mb-4">
            ...
            <div className="col-span-6 ps-7 pt-8 mb-4">
            ...
            <div className="col-span-6 ps-7 pt-7 mb-4">
