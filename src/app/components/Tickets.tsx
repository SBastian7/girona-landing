...
function Tickets() {
    return (
        <section id="tickets-section" className="main-content flex flex-col items-center justify-center text-shadow text-center" >
            <div className="text-5xl gothamFont uppercase font-extrabold py-5">Contacto</div>
            <div className="md:text-2xl py-7 font-bold">
