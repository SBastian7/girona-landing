...
function Tickets() {
    return (
        <>
            ...
            <section className="main-content flex flex-col items-center justify-center text-shadow" >
                <div className="montiliviFont uppercase text-7xl">Contacto</div>
                ...
                <div className="montiliviFont uppercase text-5xl my-10">Descubre y disfruta del Tour Montilivi</div>
                <Button title="Entradas" link="https://bstadium.es/tours-originales/" />
                <div className="pt-10">
